...
```bash React
pnpm dlx shadcn@4.13.0 add @opentui-ui/react/radio-group
```

```bash Solid
pnpm dlx shadcn@4.13.0 add @opentui-ui/solid/radio-group
```

```bash Core
pnpm dlx shadcn@4.13.0 add @opentui-ui/core/radio-group
```
