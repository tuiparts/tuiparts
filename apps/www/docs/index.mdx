...
OpenTUI UI is a component foundation for
...
| Package | Purpose |
| --- | --- |
| `@opentui-ui/core` | Framework-neutral primitive state and Renderables |
| `@opentui-ui/react` | React compound-part adapters |
| `@opentui-ui/solid` | Solid compound-part adapters |
...
no reusable interaction behavior. `@opentui-ui/dialog` and `@opentui-ui/toast`
...
<CardGroup cols={2}>
  ...
  <Card title="Components" href="/components" icon="layout-grid">
